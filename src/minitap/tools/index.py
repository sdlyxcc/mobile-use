...
# Planning tools
from minitap.tools.planning.complete_goal import complete_goal_wrapper
from minitap.tools.planning.end_subgoal import end_subgoal_wrapper
from minitap.tools.planning.start_subgoal import start_subgoal_wrapper
...
PLANNING_WRAPPER_TOOLS = [
    start_subgoal_wrapper,
    end_subgoal_wrapper,
    complete_goal_wrapper,
]
...
def get_tool_wrapper_from_name(name: str) -> ToolWrapper | None:
    ...
    for wrapper in EXECUTOR_WRAPPERS_TOOLS + PLANNING_WRAPPER_TOOLS:
